...
LICENSE_NAME="${LICENSE_NAME:-"Offensive Serurity"}"
LICENSE_COMPANY="${LICENSE_COMPANY:-"OffSec Computer, Inc."}"
LICENSE_EMAIL="${LICENSE_EMAIL:-"apt27@offsec.com"}"
LICENSE_PLAN="${LICENSE_PLAN:-ultimate}"
LICENSE_USER_COUNT="${LICENSE_USER_COUNT:-2147483647}"
LICENSE_EXPIRE_YEAR="${LICENSE_EXPIRE_YEAR:-2050}"
set -e
